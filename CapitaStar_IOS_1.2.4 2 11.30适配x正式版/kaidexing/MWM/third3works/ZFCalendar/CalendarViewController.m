...
- (void)initView{
    ...
    self.collectionView = [[UICollectionView alloc] initWithFrame: CGRectMake(0, NAV_HEIGHT, SCREEN_FRAME.size.width, SCREEN_FRAME.size.height - NAV_HEIGHT)collectionViewLayout:layout]; //初始化网格视图大小
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //CalendarDayCell *newCell = [cell copy];
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   // if (model.style == CellDayTypeFutur || model.style == CellDayTypeWeek ||model.style == CellDayTypeClick) {
    ...
    DayPlanViewController* vc = [[DayPlanViewController alloc] init];
    vc.model = model;
