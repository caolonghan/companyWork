...
#define CATDayLabelWidth  SCREEN_FRAME.size.width/7
...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.f, 10.0f, SCREEN_FRAME.size.width - 20, 30.f)];
    [masterLabel setBackgroundColor:[UIColor clearColor]];
    [masterLabel setTextAlignment:NSTextAlignmentCenter];
    [masterLabel setFont:FONT_17];
    self.masterLabel = masterLabel;
    self.masterLabel.textColor = DEFAULT_GREEN_COLOR;
    ...
    self.day2OfTheWeekLabel.textColor = DEFAULT_COLOR_999;
    ...
    self.day3OfTheWeekLabel.textColor = DEFAULT_COLOR_999;
    ...
    self.day4OfTheWeekLabel.textColor = DEFAULT_COLOR_999;
    ...
    self.day5OfTheWeekLabel.textColor = DEFAULT_COLOR_999;
    ...
    self.day6OfTheWeekLabel.textColor = DEFAULT_COLOR_999;
    ...
    self.day7OfTheWeekLabel.textColor = DEFAULT_COLOR_999;
