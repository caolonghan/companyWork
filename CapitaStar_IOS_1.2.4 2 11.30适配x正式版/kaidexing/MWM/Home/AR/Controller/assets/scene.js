...
var NativeJsBinding = function () {
    ...
    functions["request:NativeJsBinding.ShowTopUI"] = function (receiver, params, sendMessage) {
        receiver.ShowTopUI();
    };
    functions["request:NativeJsBinding.HideTopUI"] = function (receiver, params, sendMessage) {
        receiver.HideTopUI();
    };
...
var nativeReceiver = {
    ...
    ShowTopUI: function () {
           console.log("[Js] request:NativeJsBinding.ShowTopUI : default ");
    },
    HideTopUI: function () {
           console.log("[Js] request:NativeJsBinding.HideTopUI : default ");
    },
};
