...
- (void)lew_presentPopupView:(UIView *)popupView onParentBottom:(BOOL) onParentBottom animation:(id<LewPopupAnimation>)animation dismissed:(void (^)(void))dismissed{
    [self presentPopupView:popupView onParentBottom:onParentBottom animation:animation dismissed:dismissed];
}
...
- (void)presentPopupView:(UIView*)popupView onParentBottom:(BOOL) onParentBottom animation:(id<LewPopupAnimation>)animation dismissed:(void(^)(void))dismissed{
    ...
    if(onParentBottom){
        popupView.frame = CGRectMake(popupView.frame.origin.x,[UIScreen mainScreen].bounds.size.height -  popupView.frame.size.height, popupView.frame.size.width, popupView.frame.size.height);
    }else{
        popupView.center = self.lewOverlayView.center;
    }
    if (animation) {
        [animation showView:popupView overlayView:self.lewOverlayView onParentBottom:onParentBottom];
    }
...
- (void)presentPopupView:(UIView*)popupView animation:(id<LewPopupAnimation>)animation dismissed:(void(^)(void))dismissed{
    [self presentPopupView:popupView onParentBottom:NO animation:animation dismissed:dismissed];
}
