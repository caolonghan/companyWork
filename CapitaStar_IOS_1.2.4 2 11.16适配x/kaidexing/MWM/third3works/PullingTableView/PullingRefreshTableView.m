...
- (id)initWithFrame:(CGRect)frame style:(UITableViewStyle)style
{
    ...
    if (self) {
       ...
       // self.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"pic_background"]];
        ...
        _odrefreshControl = [[ODRefreshControl alloc] initInScrollView:self];
...
//    if (offset.y < -kPROffsetY) {
        ...
        //if ((offset.y + size.height - contentSize.height) > kPROffsetY){
...
- (void)tableViewDidFinishedLoadingWithMessage:(NSString *)msg{
    ...
    if (_headerView.state == kPRStateLoading) {
        ...
        [self performSelectorOnMainThread:@selector(makeNoEdgeInset) withObject:nil waitUntilDone:NO];
    }
